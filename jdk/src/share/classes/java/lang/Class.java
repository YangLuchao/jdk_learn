...
public final class Class<T> implements java.io.Serializable,
    ...
    @CallerSensitive
    /*
     * 可以通过调用ClassLoader类的loadClass()方法装载类，还可以调用java.lang.Class.forName()方法通过反射的方式完成装载类。
     * loadClass()方法只是将Class文件装载到HotSpot VM中，而forName()方法会完成类的装载、链接和初始化过程
     */
    ...
    // 调用的forName0()是一个本地静态方法，HotSpot VM提供了这个方法的本地实现
