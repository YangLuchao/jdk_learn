...
// 对应的java源码：defineClass1()
// Java_java_lang_ClassLoader_defineClass1()函数主要调用了JVM_DefineClassWithSource()函数加载类，
// JVM_DefineClassWithSource()函数最终调用的是jvm_define_class_common()函数
JNIEXPORT jclass JNICALL
...
// findLoadedClass()方法
// findLoadedClass()方法调用本地函数findLoadedClass0()判断类是否已经加载
JNIEXPORT jclass JNICALL
