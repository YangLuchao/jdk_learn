...
class arrayOopDesc : public oopDesc {
 ...
 public:
  ...
  static int length_offset_in_bytes() {
    // 在length_offset_in_bytes()函数中，使用-XX:+UseCompressedClassPointers选项来压缩类指针，
    // 默认值为true。sizeof(arrayOopDesc)的返回值为16，其中_mark和_metadata._klass各占用8字节。
