...
// GenCollectedHeap表示整个堆将采用分代，由于Serial和Serial Old收集器将堆分为年轻代和老年代，所以堆会使用GenCollectedHeap实例表示。
// GenCollectedHeap继承关系如图所示： test/ylctest/8/8.3/CollectedHeap类的继承体系.png
